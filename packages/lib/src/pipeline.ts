...
export const PIPELINE_STAGES = [
  'Order Placed', 'Packaged', 'VCO Verified', 'Picked Up',
  'In Transit', 'At Hub', 'Out for Delivery', 'Delivered',
] as const;
 ...
 */
export function buildPipeline(route: string | null | undefined, currentStatus: string): PipelineNode[] {
