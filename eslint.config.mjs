...
export default tseslint.config(
  // Never lint build output, deps, or generated artifacts.
  {
    ignores: [
      ...
      '**/node_modules/**',
      '**/*.tsbuildinfo',
      // Gradle's output. Capacitor copies its own native-bridge.js in here, and it
      // trips a rule this config does not define — so `lint` went red for anyone who
      // had built the APK, on a file that is git-ignored and was never ours.
      '**/android/**/build/**',
